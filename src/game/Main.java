...
public class Main extends Tool {
	...
	public void mousePressed(MouseEvent e) {
		controller.setPaddle(new Point(controller.getWidth(), controller.getHeight()));
	}
	...
	public void actionNameCalled(String name) {
		...
		if (name.equals("Slow Ball")){
			controller.genSlowBall();
		}
	...
	public String[] getEventNames() {
		return new String[] { "start", "stop" , "single tick",
				"ten ticks", "hundred ticks", "add ball", "Slow Ball" };
	}
