...
/**
 * This JUnit test class is designed to help you finish the Matrix Extension.
 * I (RKC) have tested it, but it may have errors.  Any errors found will
 * be posted on the course web page for this lab. If you find more errors,
 * please inform the current instructor.
 * 
